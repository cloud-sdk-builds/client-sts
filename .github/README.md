...
[`@aws-sdk/client-sts`](https://www.npmjs.com/package/@aws-sdk/client-sts/v/3.186.4).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sts@3.186.4/index.min.mjs
```

SRI SHA Hash

```text
sha384-W48QRFbY84BvxNLMcumRrnxluosJHBR/SBCzOVykW1vTjPgB8IwkQ/zLPH8kgt0L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sts": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sts@3.186.4/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sts@3.186.4/index.min.mjs": "sha384-W48QRFbY84BvxNLMcumRrnxluosJHBR/SBCzOVykW1vTjPgB8IwkQ/zLPH8kgt0L"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.186.4`)
...
```
https://github.com/cloud-sdk-builds/client-sts/blob/refs/tags/3.186.4/LICENSE
```
